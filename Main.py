...
#title
st.title("⏱ FOOD SALES DATA ANALYTICS  DASHBOARD")
st.markdown("""
    **Ini merupakan dashboard penjualan produk**  
    Dibuat oleh **Khairunnisa Aulia Rahma**  
    Email: [khairunnisaauliarahma7785@gmail.com](mailto:khairunnisaauliarahma7785@gmail.com)  
    """)
